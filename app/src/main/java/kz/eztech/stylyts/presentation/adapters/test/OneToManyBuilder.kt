...
class OneToManyBuilder<T>(
    ...
    override fun to(vararg delegates: ItemViewDelegate<T, *>): OneToManyEndpoint<T> = apply {
    ...
    @SafeVarargs
    @CheckResult(suggest = "#withLinker(Linker)")
    override fun to(vararg binders: ItemViewBinder<T, *>): OneToManyEndpoint<T> = apply {
        @Suppress("UNCHECKED_CAST")
