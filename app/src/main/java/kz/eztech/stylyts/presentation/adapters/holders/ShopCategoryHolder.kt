...
import kotlinx.android.synthetic.main.item_collection_image.view.shapeable_image_view_item_collection_image
import kotlinx.android.synthetic.main.item_shop_catergory.view.*
        ...
        with(item as GenderCategory){
            with(itemView){
                Glide.with(this).load(
                    cover_image).into(this.image_view_item_shop_fragment)
