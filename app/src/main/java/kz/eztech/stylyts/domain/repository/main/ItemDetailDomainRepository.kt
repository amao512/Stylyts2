...
interface ItemDetailDomainRepository {
    ...
    fun getItemByBarcode(token:String,value:String):Single<ClothesMainModel>
    fun saveItemByPhoto(token:String, data: ArrayList<MultipartBody.Part>):Single<ClothesMainModel>
}