 ...
 */
class PhotoChooserDialog : BaseRoundedBottomSheetDialog(R.layout.dialog_bottom_photo_chooser),
    ...
    private fun initializeListeners() {
        ...
        text_view_dialog_bottom_photo_chooser_create_publish.setOnClickListener(this)
    }
