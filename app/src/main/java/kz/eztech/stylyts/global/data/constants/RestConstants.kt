package kz.eztech.stylyts.global.data.constants
...
object RestConstants {
    ...
    const val DELETE_CLOTHES: String = "clothes/{clothes_id}"
    ...
    const val SET_DELIVERY_STATUS: String = "orders/{order_id}/delivery/set-status"
